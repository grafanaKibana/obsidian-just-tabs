...
| Change side-list width directly to 144/160/320 on Left/Right and resize narrowly. | Each slider change applies immediately on wide lists; even at 48px horizontal padding, labels retain usable space; narrow lists return to a full-width row and panels remain visible. |
